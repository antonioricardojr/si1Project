...
public class UsuarioTest {
	...
	public void testLogin() throws Exception {
		...
		try {
			...
			Assert.assertEquals("Login inv�lido", e.getMessage());
		}
	...
	public void testSenha() throws Exception {
		try {
			...
			Assert.assertEquals("Senha inv�lida", e.getMessage());
		}
	...
	public void testNome() throws Exception {
		try {
			...
			Assert.assertEquals("Nome inv�lido", e.getMessage());
	...
	public void testEndereco(){
		try{
			...
			Assert.assertEquals("Endere�o inv�lido", e.getMessage());
		}
	...
	public void testeAdicionarERemoverCarona() throws Exception{
		...
		Carona c1 = new Carona("Campina Grande", "Jo�o Pessoa", "01/10/2012", "17:50", 3, u1.getLogin());
		...
		Carona c2 = new Carona("Campina Grande", "Jo�o Pessoa", "07/10/2012", "14:40", 2, u2.getLogin());
		u2.adicionaCarona(c2.getId());
		Assert.assertEquals(c2, u2.getCaronas().get(0));
		Assert.assertEquals(c1, u1.getCaronasComoCaroneiro().get(0));
		
		
		Carona c3 = new Carona("Recife", "Jo�o Pessoa", "16/10/2012", "20:10", 5, u3.getLogin());
