...
public class CaronaTest {
	...
	public void testOrigem() throws Exception {
		...
		try {
			c2 = new Carona(null, "Natal", "20/07/2012", "14:00", 2,usuario.getLogin());
		} catch (Exception e) {
		...
		try {
			c3 = new Carona("", "Fortaleza", "04/08/2012", "09:00", 1,usuario.getLogin());
		} catch (Exception e) {
			assertEquals("Origem inv�lida", e.getMessage());
		}
		
		try {
			c4 = new Carona("", "Fort@l&z@", "04/08/2012", "09:00", 1,usuario.getLogin());
		} catch (Exception e) {
			assertEquals("Origem inv�lida", e.getMessage());
		}
	...
	public void testHora() throws Exception {
		...
		try {
			c1 = new Carona("Campina Grande", "Fortaleza",
		...
		try {
			c2 = new Carona("Campina Grande", "Fortaleza",
		...
		try{
			c3 = new Carona("Campina Grande", "Fortaleza", "04/08/2012", "09000", 1,usuario.getLogin());	
		}catch(Exception e){
			assertEquals("Hora inv�lida", e.getMessage());
		}
		
		try{
			c4 = new Carona("Campina Grande", "Fortaleza", "04/08/2012", "009:0", 1,usuario.getLogin());	
		}catch(Exception e){
			assertEquals("Hora inv�lida", e.getMessage());
		}
	}
	...
	public void testData(){
		...
		try {
			c3 = new Carona("Campina Grande", "Joao Pessoa",
		...
		try {
			c4 = new Carona("Campina Grande", "Joao Pessoa",
		...
		try {
			c5 = new Carona("Campina Grande", "Joao Pessoa",
	...
	public void testVagasTotal() throws Exception{
		...
		Solicitacao s1 = new Solicitacao(gerador.geraId(), u1.getLogin(), c1.getId(), "A�ude Velho");
		Solicitacao s2 = new Solicitacao(gerador.geraId(), u2.getLogin(), c1.getId(), "Pra�a da Bandeira");
